const STRINGS = {
  de: {
    ...
    "home.source": "Der Kontext ist aus den bereitgestellten deutschen und englischen Projektmanuskripten zusammengefasst. Text und Zuschreibung bleiben bis zur Hauptprüfung vorläufig.",
  ...
  en: {
    ...
    "home.source": "Context condensed from the German and English project manuscripts supplied with the dictionary data. Copy and attribution remain provisional until the major review.",
